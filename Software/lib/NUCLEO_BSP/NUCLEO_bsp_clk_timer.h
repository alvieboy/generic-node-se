...
/**
 * @file NUCLEO_bsp_clk_timer.h
 *
 * @copyright Copyright (c) 2021 The Things Industries B.V., (c) 2021 MAIS Project
 *
 */

#ifndef NUCLEO_BSP_CLK_TIMER_H
#define NUCLEO_BSP_CLK_TIMER_H

#include "stm32wlxx_hal.h"
#include "NUCLEO_bsp_error.h"
#include "NUCLEO_bsp_conf.h"

extern TIM_HandleTypeDef NUCLEO_BSP_buzzer_timer;
extern RTC_HandleTypeDef NUCLEO_BSP_rtc;
extern IWDG_HandleTypeDef NUCLEO_BSP_iwdg;
