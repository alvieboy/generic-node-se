...
/**
 * @file NUCLEO_bsp_microphone.h
 *
 * @copyright Copyright (c) 2021 MAIS Project
 *
 */

#ifndef NUCLEO_BSP_MICROPHONE_H
#define NUCLEO_BSP_MICROPHONE_H
...
extern DMA_HandleTypeDef NUCLEO_BSP_microphone_hdma_rx;
#ifdef MICROPHONE_USE_I2S
extern I2S_HandleTypeDef NUCLEO_BSP_microphone_i2s;
#else
extern SPI_HandleTypeDef NUCLEO_BSP_microphone_spi;
#endif
...
#define MICROPHONE_RX_DMA_CHANNEL             DMA1_Channel6

#define MICROPHONE_DMA_RX_IRQn                DMA1_Channel6_IRQn
#define MICROPHONE_DMA_RX_IRQHandler          DMA1_Channel6_IRQHandler
...
#define MICROPHONE_CHANNEL MICROPHONE_RIGHT
    ...
    /* Speed of the SPI interface depends on both the system clock speed
     (24 MHz is default) and a prescaler */
#define MICROPHONE_SPI_BAUDRATE            SPI_BAUDRATEPRESCALER_8
...
#define MICROPHONE_SPI_GPIO_PORT GPIOB
...
int32_t NUCLEO_BSP_MICROPHONE_Start(void);
