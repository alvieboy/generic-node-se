...
#define UartHandle NUCLEO_BSP_debug_usart
...
{
  TxCpltCallback = cb;
  NUCLEO_BSP_UART_DMA_Init();
  NUCLEO_BSP_USART_Init();
...
void vcom_Resume(void)
{
  ...
  HAL_UART_Init(&NUCLEO_BSP_debug_usart);

  HAL_DMA_Init(&NUCLEO_BSP_hdma_tx);
}
